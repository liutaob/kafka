...
public class Kafka_Config {
    ...
    public Properties customerConfigs() {
        ...
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "latest");//位移丢失和位移越界后的恢复起始位置  读取最近的数据
    ...
    public Properties producerConfigs() {
        ...
        props.put(ProducerConfig.ACKS_CONFIG, "all");//20M 消息缓存
...
//    @Bean
//    public Producer<Integer, Object> clientKafkaProducer() {
